...
**2,488 labelled pairs** built from **260 real Crossref records** — 1,708 same-work and 780 different-work. Seed 20260909.
...
Same-work similarity spans 56–100%; different-work spans 6–74%.

The ranges **overlap**, with 36 different-work pairs scoring at or above the weakest same-work pair. Those are the cases the threshold has to adjudicate, and their presence is what makes the curve below meaningful.

## The trade-off

| Threshold | Precision | Recall | F1 | False accusations |
|---:|---:|---:|---:|---:|
| 24 | 1.000 | 0.014 | 0.028 | 0 |
| 30 | 1.000 | 0.037 | 0.072 | 0 |
| 36 | 1.000 | 0.083 | 0.154 | 0 |
| 42 | 1.000 | 0.258 | 0.410 | 0 |
| 48 | 1.000 | 0.469 | 0.639 | 0 |
| 54 | 1.000 | 0.915 | 0.956 | 0 |
| 60 | 1.000 | 0.977 | 0.988 | 0 |
| 66 | 1.000 | 0.995 | 0.997 | 0 |
| 72 | 1.000 | 0.997 | 0.999 | 0 |
...
**Threshold 76** — precision 1.000, recall 0.999, 0 false accusations across 1,708 genuine pairs.
