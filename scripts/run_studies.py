...
def main() -> int:
    ...
    ap.add_argument("--max-checks", type=int, default=2400)
    ap.add_argument("--calibration-works", type=int, default=90)
    ...
    if args.study in ("baserate", "both"):
        print("=" * 70)
    ...
    if args.study in ("calibration", "both"):
        print()
        print("=" * 70)
